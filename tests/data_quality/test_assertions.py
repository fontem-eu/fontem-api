...
# --------------------------------------------------------------------------
# What the rescan has to prove (data-backlog Part 5, C8)
# --------------------------------------------------------------------------
# Each of these is red today for a defect fixed on 2026-09-23/24. They
# exist so the reprocess campaign can be judged rather than assumed.
